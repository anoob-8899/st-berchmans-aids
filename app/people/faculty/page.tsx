      ...
      <section className="py-16 sm:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 space-y-10">
          {FACULTY_MEMBERS.length === 0 ? (
            <div className="py-16 text-center space-y-3 bg-[#F7F8F9] rounded-3xl border border-dashed border-slate-200 p-8">
              <div className="w-16 h-16 rounded-full bg-slate-100 text-slate-400 mx-auto flex items-center justify-center">
                <GraduationCap className="w-8 h-8" />
              </div>
              <h3 className="text-lg font-bold text-slate-800">Faculty Profiles Coming Soon</h3>
              <p className="text-xs text-slate-500 max-w-md mx-auto">
                Official faculty profiles for the Department of Artificial Intelligence & Data Science are currently being updated by the administration.
              </p>
            </div>
          ) : (
